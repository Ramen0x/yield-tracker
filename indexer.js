...
const RPC_PLASMA = process.env.PLASMA_RPC_URL || 'https://plasma-mainnet.g.alchemy.com/v2/_20mocA-3zrSOZqI2jMO2';
const RPC_BASE = process.env.BASE_RPC_URL || 'https://base-mainnet.g.alchemy.com/v2/_20mocA-3zrSOZqI2jMO2';
const RPC_OPT = process.env.OPT_RPC_URL || 'https://opt-mainnet.g.alchemy.com/v2/_20mocA-3zrSOZqI2jMO2';
const RPC_POLYGON = process.env.POLYGON_RPC_URL || 'https://polygon-mainnet.g.alchemy.com/v2/_20mocA-3zrSOZqI2jMO2';
const RPC_MANTLE = process.env.MANTLE_RPC_URL || 'https://mantle-mainnet.g.alchemy.com/v2/_20mocA-3zrSOZqI2jMO2';
